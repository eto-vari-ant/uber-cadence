...
import com.innowise.cadenceapp.activity.WeatherActivityImpl;
import com.innowise.cadenceapp.workflow.WeatherWorkflow;
import com.innowise.cadenceapp.workflow.WeatherWorkflowImpl;
...
import static com.innowise.cadenceapp.config.CadenceConfiguration.DOMAIN;
...
public class CadenceWorkerStarter {
    ...
    private static final Object[] ACTIVITY_IMPLEMENTATIONS = new Object[]{new WeatherActivityImpl()};
